...
public class RadarView extends View {
    ...
    private void init() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                matrix.setRotate(currentRotation, centerX, centerY);
                Log.d("RadarView", currentRotation + "");
                invalidate();
            }
        });
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        radarShader = new SweepGradient(centerX, centerY, new int[]{0x00ffffff, 0x00ffffff, 0xaaffffff}, new float[]{0,
                0.0f, 1});
    }
    ...
    private void drawBitmaps(Canvas canvas) {
        ...
        double startAngle = currentRotation / 360.0 * (Math.PI * 2.0) + (this.bitmapSlotCount - bitmapShowCount) * angle;
...
//        Shader shader = new SweepGradient(centerX, centerY, Color.TRANSPARENT, Color.WHITE);
